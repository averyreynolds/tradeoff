...
- (7/21): Made backend changes to more precisely make computations, API request format more consistent, and allow for frontend dev. Added a placeholder frontend folder in directory. Currently learning frontend HTML/CSS/JS component in TOP
